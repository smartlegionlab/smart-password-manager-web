# Smart Password Manager Web <sup>v2.0.4</sup>
...
> **⚠️ This release (v2.0.4) uses a completely redesigned cryptographic algorithm that is NOT backward compatible with v1.x.x**
...
- Smart passwords created with v1.3.7 or earlier **cannot be regenerated** using v2.0.4
...
### Migrating from v1.x.x to v2.0.4
...
- After regenerating passwords with v2.0.4, update them in each website/service
- Test login before removing old access

**Important**: v1.x.x and v2.0.4 passwords are NOT compatible. You must regenerate all passwords.
...
|------------------|-------------|--------------------------|------------------------|
| v1.3.7 and below | Server-side | ❌ Deprecated/Unsupported | Must migrate to v2.0.4 |
| v2.0.4+          | Client-side | ✅ Current                | N/A                    |
